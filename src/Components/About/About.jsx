  ...
  return (
    <div className='about'>
      ...
      <div className="about-right">
        ...
        <p>With a focus on innovative, hands-on learning and personalised mentorship, our programs prepare aspiring educators to make a meaningful impact in classroom, schools, and communities.</p>
